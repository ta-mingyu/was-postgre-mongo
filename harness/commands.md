...
# 4. CLAUDE.md 링크를 신규 버전으로 갱신

# 5. todo.md 체크박스 [x] 갱신
```

상세(도메인 로드 순서, 검증 체크리스트, HITL 가드)는 `.claude/skills/update-guide` 스킬 참조.
...
팀 현재 설정 vs 표준값 비교 절차는 `.claude/skills/gap-analysis` 스킬 참조.
